...
//       .then((result) => {
//         const tokenFromRequest = JSON.stringify(result.user.accessToken);
//         localStorage.setItem("token", tokenFromRequest);
...
//       <button onClick={handleGoogleSignIn} className="login-button">Sign In with <FaGoogle style={{fontSize:'18px'}}/> </button>
